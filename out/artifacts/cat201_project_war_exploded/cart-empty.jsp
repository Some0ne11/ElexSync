...
<main>
    ...
    <!-- category start -->
    <section class="slider-category bt section-ptb">
        <div class="container">
            <div class="row">
                <div class="col">
                    <ul class="cat-wrap">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide" data-animate="animate__fadeInUp">
                                        <div class="cate-info">
                                            ...
                                            <h6 class="cat-title">Wireless earbuds</h6>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeInUp">
                                        <div class="cate-info">
                                            <div class="category-block">
                                                <a href="collection.html" class="cat-img banner-hover">
                                                    <img src="img/cat/home-1-cate2.jpg" class="img-fluid" alt="cate2">
                                                </a>
                                            </div>
                                            <span class="text-content">+18</span>
                                            <h6 class="cat-title">Portable speaker</h6>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeInUp">
                                        <div class="cate-info">
                                            <div class="category-block">
                                                <a href="collection.html" class="cat-img banner-hover">
                                                    <img src="img/cat/home-1-cate3.jpg" class="img-fluid" alt="cate3">
                                                </a>
                                            </div>
                                            <span class="text-content">+25</span>
                                            <h6 class="cat-title">Air conditioner</h6>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeInUp">
                                        <div class="cate-info">
                                            <div class="category-block">
                                                <a href="collection.html" class="cat-img banner-hover">
                                                    <img src="img/cat/home-1-cate4.jpg" class="img-fluid" alt="cate4">
                                                </a>
                                            </div>
                                            <span class="text-content">+25</span>
                                            <h6 class="cat-title">Ev charging plug</h6>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeInUp">
                                        <div class="cate-info">
                                            <div class="category-block">
                                                <a href="collection.html" class="cat-img banner-hover">
                                                    <img src="img/cat/home-1-cate5.jpg" class="img-fluid" alt="cate5">
                                                </a>
                                            </div>
                                            <span class="text-content">+05</span>
                                            <h6 class="cat-title">DVD player slot </h6>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeInUp">
                                        <div class="cate-info">
                                            <div class="category-block">
                                                <a href="collection.html" class="cat-img banner-hover">
                                                    <img src="img/cat/home-1-cate6.jpg" class="img-fluid" alt="cate6">
                                                </a>
                                            </div>
                                            <span class="text-content">+09</span>
                                            <h6 class="cat-title">360 cemera</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
