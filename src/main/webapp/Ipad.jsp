                            ...
                            <div class="product-detail-img product-detail-img-bottom">
                                <div class="product-img-top">
                                    ...
                                    <div class="slider-big-7 slick-slider">
                                        <div class="slick-slide ">
                                            <a href="img/product/ipad1.jpg.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/ipad1.jpg');">
                                                    <img src="img/product/ipad1.jpg" class="img-fluid" alt="pro-1">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/ipad2.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/ipad2.jpg');">
                                                    <img src="img/product/ipad2.jpg" class="img-fluid" alt="pro-2">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/ipad3.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/ipad3.jpg');">
                                                    <img src="img/product/ipad3.jpg" class="img-fluid" alt="p-3">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/ipad4.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/ipad4.jpg');">
                                                    <img src="img/product/ipad4.jpg" class="img-fluid" alt="pro-4">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/ipad5.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/ipad5.jpg');">
                                                    <img src="img/product/ipad5.jpg" class="img-fluid" alt="pro-5">
                                                </figure>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="pro-slider">
                                    <div class="slider-small-7 pro-detail-slider small-slider">
                                        ...
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                                <img src="img/product/ipad3.jpg" class="img-fluid" alt="pro-3">
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                ...
                                <div class="pro-nprist">
                                    ...
                                    <div class="product-info">
                                        <div class="pro-prlb pro-sale">
                                            <div class="price-box">
                                                <span class="new-price">RM 1700.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                        <div class="product-inventory">
                                            <div class="stock-inventory stock-more">
                                                <p class="text-success">Hurry up! only
                                                    <span class="available-stock bg-success">67</span>
                                                    <span>products left in stock!</span>
                                                </p>
                                            </div>
                                            <div class="stock-inventory stock-zero collapse">
                                                <p class="text-danger">Unfortunately
                                                    <span class="available-stock bg-danger">67</span>
                                                    <span>products left in stock!</span>
                                                </p>
                                            </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="delivery-block">
                                                        <div class="space-block">
                                                            ...
                                                            <p>Always free shipping for orders over RM250.</p>
                                                        ...
                                                        <div class="space-block">
                                                            ...
                                                            <p>Email:<a href="elexsync@gmail.com">elexsync@gmail.com</a></p>
                                                        ...
                                                        <div class="single-product-wrap">
                                                            <div class="product-image">
                                                                <a class="pro-img" href="collection.html">
                                                                    <img class="img-fluid img1 resp-img1" src="img/product/ipad3.jpg"
                                                                         alt="p-1">
                                                                    <img class="img-fluid img2 resp-img2" src="img/product/ipad3.jpg"
                                                                         alt="p-2">
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <div class="pro-title-price">
                                                                    <h6><a href="Ipad.jsp">Ipad Air</a></h6>
                                                                    <div class="product-price">
                                                                        <div class="price-box">
                                                                            <span class="new-price">RM1700.00</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="product-info">
                                        <div class="product-sku">
                                            <h6>SKU:</h6>
                                            <span class="variant-sku">udte-14</span>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                ...
                                <div class="collapse show" id="description" data-bs-parent="#collapse-tab" role ="tab" aria-expanded="true">
                                    <div class="description-review-text">
                                        <div class="product-description">
                                            <p>The Ipad Air is the latest technology of Apple where dreams meet. The Ipad Air boasts serious performance in a thin and light design, providing comfort and portability.</p>
                                            <h6>About this item</h6>
                                            <ul>
                                                <li>A 13'' display equipped with Liquid Retina technology, P3 Wide Colour, True Tone and anti-reflective coating.</li>
                                                <li>Equipped with M2 Chip.</li>
                                                <li>A landscape 12MP Center Stage Camera.</li>
                                                <li>Built and adapted for Apple Intelligence.</li>
                                                <li>Supports Apple Pencil Pro and Apple Pencil (USB-C).</li>
                                ...
                                <div class="collapse" id="other-content" data-bs-parent="#collapse-tab">
                                    <div class="description-review-text">
                                        <div class="product-custom-content">
                                            <p>The Ipad Air comes with the Apple pencil (USB-C) as a free gift when you are purchasing from our store. Not only that, our pgae features a 3 year warranty with every product bought and free services. Term and Conditions apply.</p>
                                            <p>Grab now while stock lasts!. Enjoy your life with a touch of the heavens.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                    ...
                                    <div class="description-review-text">
                                        <div class="video">
                                            <div class="video-wrapper">
                                                <iframe src="https://www.youtube.com/embed/bFJ8RZliQ5Y?si=6HFw0nKmr5j8eFbZ" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
