                            ...
                            <div class="product-detail-img product-detail-img-bottom">
                                <div class="product-img-top">
                                    ...
                                    <div class="slider-big-7 slick-slider">
                                        <div class="slick-slide ">
                                            <a href="img/product/airpods1.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/airpods1.jpg');">
                                                    <img src="img/product/airpods1.jpg" class="img-fluid" alt="pro-1">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/airpods2.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/airpods2.jpg');">
                                                    <img src="img/product/airpods2.jpg" class="img-fluid" alt="pro-2">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/airpods3.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/airpods3.jpg');">
                                                    <img src="img/product/airpods3.jpg" class="img-fluid" alt="p-3">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/airpods4.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/airpods4.jpg');">
                                                    <img src="img/product/airpods4.jpg" class="img-fluid" alt="pro-4">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/airpods5.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/airpods5.jpg');">
                                                    <img src="img/product/airpods5.jpg" class="img-fluid" alt="pro-5">
                                                </figure>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="pro-slider">
                                    <div class="slider-small-7 pro-detail-slider small-slider">
                                        ...
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                                <img src="img/product/airpods3.jpg" class="img-fluid" alt="pro-3">
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                ...
                                <div class="pro-nprist">
                                                        ...
                                                        <div class="single-product-wrap">
                                                            <div class="product-image">
                                                                <a class="pro-img" href="collection.html">
                                                                    <img class="img-fluid img1 resp-img1" src="img/product/airpods5.jpg"
                                                                         alt="p-1">
                                                                    <img class="img-fluid img2 resp-img2" src="img/product/airpods5.jpg"
                                                                         alt="p-2">
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <div class="pro-title-price">
                                                                    <h6><a href="product-template.html">Airpods 2</a></h6>
                                                                    <div class="product-price">
                                                                        <div class="price-box">
                                                                            <span class="new-price">RM150.00</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="product-info">
                                        <div class="product-sku">
                                            <h6>SKU:</h6>
                                            <span class="variant-sku">opue-15</span>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                ...
                                <div class="collapse show" id="description" data-bs-parent="#collapse-tab" role ="tab" aria-expanded="true">
                                    <div class="description-review-text">
                                        <div class="product-description">
                                            <p>Airpods 2 combine an iconic design and high-quality sound. Providing a magical wireless experience and a fit that's comfortable all day. Put them in your ears and they connect immediately.</p>
                                            <h6>About this item</h6>
                                            <ul>
                                                <li>More than 24 hours of total listening time with the Lightning Charging Case.</li>
                                        ...
                                        <div class="product-additional-info">
                                            <table>
                                                ...
                                                <tr class="product-info">
                                                    <th>Type</th>
                                                    <td>
                                                        <a href="javascript:void(0)">Wireless Earbuds</a>
                                                    </td>
                                                </tr>
                                                <tr class="product-info">
                                                    <th>Color</th>
                                ...
                                <div class="collapse" id="other-content" data-bs-parent="#collapse-tab">
                                    <div class="description-review-text">
                                        <div class="product-custom-content">
                                            <p>The Airpods 2comes with the Lightning Charging Case and a free Airpods case when buying with our store Not only that, our pgae features a 3 year warranty with every product bought and free services. Term and Conditions apply.</p>
                                    ...
                                    <div class="description-review-text">
                                        <div class="video">
                                            <div class="video-wrapper">
                                                <iframe src="https://www.youtube.com/embed/wZxYlMnxI_w?si=3iuBfchfsSl2dUDl" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
