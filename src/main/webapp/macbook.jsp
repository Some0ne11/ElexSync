                ...
                <div class="product-img-top">
                  ...
                  <div class="slider-big-7 slick-slider">
                    <div class="slick-slide ">
                      <a href="img/product/macbook.png" class="product-single">
                        <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/macbook.png');">
                          <img src="img/product/macbook.png" class="img-fluid" alt="pro-1">
                        </figure>
                      </a>
                    </div>
                    <div class="slick-slide ">
                      <a href="img/product/macbook2.png" class="product-single">
                        <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/macbook2.png');">
                          <img src="img/product/macbook2.png" class="img-fluid" alt="pro-2">
                        </figure>
                      </a>
                    </div>
                    <div class="slick-slide ">
                      <a href="img/product/macbook3.jpg" class="product-single">
                        <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/macbook3.jpg');">
                          <img src="img/product/macbook3.jpg" class="img-fluid" alt="p-3">
                        </figure>
                      </a>
                    </div>
                    <div class="slick-slide ">
                      <a href="img/product/macbook4.jpg" class="product-single">
                        <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/macbook4.jpg');">
                          <img src="img/product/macbook4.jpg" class="img-fluid" alt="pro-4">
                        </figure>
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="slider-small-7 pro-detail-slider small-slider">
                    <div class="slick-slide ">
                      <a href="javascript:void(0)" class="product-single--thumbnail">
                        <img src="img/product/macbook.png" class="img-fluid" alt="macbook1">
                      </a>
                    </div>
                    <div class="slick-slide ">
                      <a href="javascript:void(0)" class="product-single--thumbnail">
                        <img src="img/product/macbook2.png" class="img-fluid" alt="macbook2">
                      </a>
                    </div>
                    <div class="slick-slide ">
                      <a href="javascript:void(0)" class="product-single--thumbnail">
                        <img src="img/product/macbook3.jpg" class="img-fluid" alt="pro-3">
                      </a>
                    </div>
                    <div class="slick-slide ">
                      <a href="javascript:void(0)" class="product-single--thumbnail">
                ...
                <div class="pro-nprist">
                  ...
                  <div class="product-info">
                    ...
                    <div class="product-ratting">
                      ...
                      <span class="spr-badge-caption">4 Reviews</span>
                    </div>
                    <!-- product-rating end -->
                  </div>
                  <div class="product-info">
                    ...
                    <div class="product-inventory">
                      <div class="stock-inventory stock-more">
                        <p class="text-success">Hurry up! only
                          <span class="available-stock bg-success">101</span>
                          <span>products left in stock!</span>
                        </p>
                      </div>
                      <div class="stock-inventory stock-zero collapse">
                        <p class="text-danger">Unfortunately
                          <span class="available-stock bg-danger">101</span>
                          <span>products left in stock!</span>
                        </p>
                      </div>
                          ...
                          <div class="swatch-variant">
                            <div class="swatch clearfix Color">
                              <div class="header">
                                <h6>
                                  <span>Color:</span>
                                  <span class="data-value">Matte Black</span>
                                </h6>
                              </div>
                              <div class="variant-wrap">
                                <div class="variant-property">
                                  <div class="swatch-element color Black">
                                    <input type="radio" name="option-0" value="Matte Black" id="color-black" checked>
                                    <label for="color-black">Matte Black</label>
                                  </div>
                                  <div class="swatch-element color Gray">
                                    <input type="radio" name="option-0" value="Cloudy Gray" id="color-gray">
                                    <label for="color-gray">Cloudy Gray</label>
                                  </div>
                                  <div class="swatch-element color Gold">
                                    <input type="radio" name="option-0" value="Premium Gold" id="color-gold">
                                    <label for="color-gold">Premium Gold</label>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="delivery-block">
                            <div class="space-block">
                              <h4>Delivery</h4>
                              <p>All orders shipped with Express.</p>
                              <p>Always free shipping for orders over RM 250.</p>
                            ...
                            <div class="space-block">
                              ...
                              <p>Email:<a href="mailto:contact@domain.com">ElexSync@gmail.com</a></p>
                              <p>Phone:<a href="tel:+1(23)456789">+60 (12) 342 132</a></p>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="product-form-list">
                            <div class="single-product-wrap">
                              <div class="product-image">
                                <a class="pro-img" href="macbook.jsp">
                                  <img class="img-fluid img1 resp-img1" src="img/product/macbook.png"
                                       alt="p-1">
                                  <img class="img-fluid img2 resp-img2" src="img/product/macbook2.png"
                                       alt="p-2">
                                </a>
                              </div>
                              <div class="product-content">
                                <div class="pro-title-price">
                                  <h6><a href="macbook.jsp">Macbook</a></h6>
                  ...
                  <div class="product-info">
                    <div class="product-sku">
                      <h6>SKU:</h6>
                      <span class="variant-sku">MBP-2023-14</span>
                    </div>
                  </div>
                  <div class="product-info">
                ...
                <div class="collapse show" id="description" data-bs-parent="#collapse-tab" role="tab" aria-expanded="true">
                  <div class="description-review-text">
                    <div class="product-description">
                      <p>The MacBook is a sleek, high-performance laptop designed for productivity, creativity, and seamless connectivity. With a lightweight design and powerful hardware, it's perfect for professionals, students, and creatives alike.</p>
                      <h6>About this item</h6>
                      <ul>
                        <li>Powered by the latest Apple M-series chip for exceptional speed and efficiency.</li>
                        <li>Up to 18 hours of battery life for all-day productivity.</li>
                        <li>Brilliant Retina display with True Tone for stunning visuals.</li>
                        <li>Touch ID for secure login and online purchases.</li>
                        <li>Lightweight and portable, perfect for on-the-go use.</li>
                        <li>macOS with intuitive features and seamless integration with other Apple devices.</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class="collapse" id="other-content" data-bs-parent="#collapse-tab">
                  <div class="description-review-text">
                    <div class="product-custom-content">
                      <p>The MacBook's advanced features and design make it a leader in the industry. Experience seamless multitasking, vivid visuals, and powerful performance in a lightweight package.</p>
                      <p>Perfect for content creators, professionals, and anyone looking for a reliable and stylish laptop.</p>
                    </div>
                  </div>
                </div>
              </li>
                  ...
                  <div class="description-review-text">
                    <div class="video">
                      <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/IHTT_7AjoU8?si=DscDFFpAp5NoLux-" allowfullscreen></iframe>
                      </div>
                    </div>
                  </div>
                </div>
