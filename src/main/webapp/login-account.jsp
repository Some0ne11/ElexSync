            ...
            <div class="header-element header-logo">
              <div class="header-theme-logo">
                <a href="index.html" class="theme-logo">
                  <img src="../src/main/webapp/img/logo/logo.png" class="img-fluid" alt="logo">
                </a>
              </div>
            </div>
                ...
                <div class="vegawrap collapse" id="vega-collapse">
                  <ul class="vega-menu">
                    <li class="menu-link">
                      <a href="collection.html" class="link-title">
                                                        <span class="menu-img-icon">
                                                            <img src="../src/main/webapp/img/menu/cate-menu1.jpg" class="img-fluid" alt="cate-menu1">
                                                        </span>
                          ...
                          <li class="productlink-li shoplink-br">
                            <div class="shop-banner banner-hover">
                              <a href="" class="banner-img">
                                <img src="../src/main/webapp/img/menu/vega-banner1.jpg" class="img-fluid" alt="vega-banner1">
                              </a>
                            </div>
                          </li>
                          <li class="productlink-li shoplink-br">
                            <div class="shop-banner banner-hover">
                              <a href="" class="banner-img">
                                <img src="../src/main/webapp/img/menu/vega-banner2.jpg" class="img-fluid" alt="vega-banner2">
                              </a>
                            </div>
                          </li>
                        </ul>
                    ...
                    <li class="menu-link">
                      <a href="collection.html" class="link-title">
                                                        <span class="menu-img-icon">
                                                            <img src="../src/main/webapp/img/menu/cate-menu2.jpg" class="img-fluid" alt="cate-menu2">
                                                        </span>
                    ...
                    <li class="menu-link">
                      <a href="collection.html" class="link-title">
                                                        <span class="menu-img-icon">
                                                            <img src="../src/main/webapp/img/menu/cate-menu3.jpg" class="img-fluid" alt="cate-menu3">
                                                        </span>
                              ...
                              <div class="swiper-wrapper">
                                  ...
                                  <div class="product-menu-grid">
                                    <div class="product-image">
                                      <a href="product-template.htm" class="pro-img">
                                        <img src="../src/main/webapp/img/product/home1-pro-1.jpg" class="img-fluid" alt="home1-pro-1">
                                      </a>
                                    </div>
                                ...
                                <div class="swiper-slide swiper-slide-prev">
                                  <div class="product-menu-grid">
                                    <div class="product-image">
                                      <a href="product-template.htm" class="pro-img">
                                        <img src="../src/main/webapp/img/product/home1-pro-3.jpg" class="img-fluid" alt="home1-pro-3">
                                      </a>
                                    </div>
                                    <div class="product-content">
                                      <div class="product-sub-title">
                                ...
                                <div class="swiper-slide swiper-slide-prev">
                                  <div class="product-menu-grid">
                                    <div class="product-image">
                                      <a href="product-template.htm" class="pro-img">
                                        <img src="../src/main/webapp/img/product/home1-pro-5.jpg" class="img-fluid" alt="home1-pro-5">
                                      </a>
                                    </div>
                                    <div class="product-content">
                                      <div class="product-sub-title">
                                ...
                                <div class="swiper-slide swiper-slide-prev">
                                  <div class="product-menu-grid">
                                    <div class="product-image">
                                      <a href="product-template.htm" class="pro-img">
                                        <img src="../src/main/webapp/img/product/home1-pro-7.jpg" class="img-fluid" alt="home1-pro-7">
                                      </a>
                                    </div>
                                    <div class="product-content">
                                      <div class="product-sub-title">
                                ...
                                <div class="swiper-slide swiper-slide-prev">
                                  <div class="product-menu-grid">
                                    <div class="product-image">
                                      <a href="product-template.htm" class="pro-img">
                                        <img src="../src/main/webapp/img/product/home1-pro-9.jpg" class="img-fluid" alt="home1-pro-9">
                                      </a>
                                    </div>
                                    <div class="product-content">
                                      <div class="product-sub-title">
                                ...
                                <div class="swiper-slide swiper-slide-prev">
                                  <div class="product-menu-grid">
                                    <div class="product-image">
                                      <a href="product-template.htm" class="pro-img">
                                        <img src="../src/main/webapp/img/product/home1-pro-13.jpg" class="img-fluid" alt="home1-pro-13">
                                      </a>
                                    </div>
                                    <div class="product-content">
                                      <div class="product-sub-title">
                                ...
                                <div class="swiper-slide swiper-slide-prev">
                                  <div class="product-menu-grid">
                                    <div class="product-image">
                                      <a href="product-template.htm" class="pro-img">
                                        <img src="../src/main/webapp/img/product/home1-pro-12.jpg" class="img-fluid" alt="home1-pro-12">
                                      </a>
                                    </div>
                                    <div class="product-content">
                                      <div class="product-sub-title">
                    ...
                    <li class="menu-link">
                      <a href="collection.html" class="link-title">
                                                        <span class="menu-img-icon">
                                                            <img src="../src/main/webapp/img/menu/cate-menu4.jpg" class="img-fluid" alt="cate-menu4">
                                                        </span>
                    ...
                    <li class="menu-link">
                      <a href="collection.html" class="link-title">
                                                        <span class="menu-img-icon">
                                                            <img src="../src/main/webapp/img/menu/cate-menu5.jpg" class="img-fluid" alt="cate-men5">
                                                        </span>
                    ...
                    <li class="menu-link">
                      <a href="collection.html" class="link-title">
                                                        <span class="menu-img-icon">
                                                            <img src="../src/main/webapp/img/menu/cate-menu6.jpg" class="img-fluid" alt="cate-menu6">
                                                        </span>
                    ...
                    <li class="menu-link">
                      <a href="collection.html" class="link-title">
                                                        <span class="menu-img-icon">
                                                            <img src="../src/main/webapp/img/menu/cate-menu7.jpg" class="img-fluid" alt="cate-menu7">
                                                        </span>
                      ...
                      <div class="menu-dropdown menu-banner collapse" id="collapse-shop">
                        <ul class="container ul">
                          <li class="menubanner-li">
                            <div class="menubanner-img">
                              <a href="collection.html" class="banner-hover">
                                <img src="../src/main/webapp/img/menu/home1-menu-banner1.jpg" class="img-fluid" alt="menu-banner1">
                              </a>
                          ...
                          <li class="menubanner-li">
                            <div class="menubanner-img">
                              <a href="collection.html" class="banner-hover">
                                <img src="../src/main/webapp/img/menu/home1-menu-banner2.jpg" class="img-fluid" alt="menu-banner2">
                              </a>
                              <a href="collection.html" class="collection-title">
                          ...
                          <li class="menubanner-li">
                            <div class="menubanner-img">
                              <a href="collection.html" class="banner-hover">
                                <img src="../src/main/webapp/img/menu/home1-menu-banner3.jpg" class="img-fluid" alt="menu-banner3">
                              </a>
                              <a href="collection.html" class="collection-title">
                          ...
                          <li class="menubanner-li">
                            <div class="menubanner-img">
                              <a href="collection.html" class="banner-hover">
                                <img src="../src/main/webapp/img/menu/home1-menu-banner4.jpg" class="img-fluid" alt="menu-banner4">
                              </a>
                              <a href="collection.html" class="collection-title">
                                    ...
                                    <div class="single-product-wrap">
                                      <div class="product-image">
                                        <a href="product-template.html" class="pro-img">
                                          <img class="img-fluid img1" src="../src/main/webapp/img/menu/home-pro-banner1.jpg" alt="menupro-1">
                                          <img class="img-fluid img2" src="../src/main/webapp/img/menu/home-pro-banner2.jpg" alt="menupro-2">
                                        </a>
                                      </div>
                                      <div class="product-content">
                                        <h6><a href="product-template.html">Bluetooth earbuds</a></h6>
                                ...
                                <li class="menumegasup-li">
                                  <div class="product-menu-list">
                                    <div class="single-product-wrap">
                                      <div class="product-image">
                                        <a href="product-template.html" class="pro-img">
                                          <img class="img-fluid img1" src="../src/main/webapp/img/menu/home-pro-banner3.jpg" alt="menupro-1">
                                          <img class="img-fluid img2" src="../src/main/webapp/img/menu/home-pro-banner4.jpg" alt="menupro-2">
                                        </a>
                                      </div>
                                      <div class="product-content">
                                ...
                                <li class="menumegasup-li">
                                  <div class="product-menu-list">
                                    <div class="single-product-wrap">
                                      <div class="product-image">
                                        <a href="product-template.html" class="pro-img">
                                          <img class="img-fluid img1" src="../src/main/webapp/img/menu/home-pro-banner5.jpg" alt="menupro-1">
                                          <img class="img-fluid img2" src="../src/main/webapp/img/menu/home-pro-banner6.jpg" alt="menupro-2">
                                        </a>
                                      </div>
                                      <div class="product-content">
                                ...
                                <li class="menumegasup-li">
                                  <div class="product-menu-list">
                                    <div class="single-product-wrap">
                                      <div class="product-image">
                                        <a href="product-template.html" class="pro-img">
                                          <img class="img-fluid img1" src="../src/main/webapp/img/menu/home-pro-banner7.jpg" alt="menupro-1">
                                          <img class="img-fluid img2" src="../src/main/webapp/img/menu/home-pro-banner8.jpg" alt="menupro-2">
                                        </a>
                                      </div>
                                      <div class="product-content">
          ...
          <ul class="footer-ul">
            <li class="footer-li footer-logo" data-animate="animate__fadeInUp">
              <div class="footer-content">
                <a href="index.html" class="theme-logo">
                  <img src="../src/main/webapp/img/logo/logo.png" class="img-fluid" alt="footer-logo">
                </a>
                ...
                <div class="app-code">
                  ...
                  <div class="code-1">
                    <a href="index.html" class="image">
                      <img src="../src/main/webapp/img/footer/home-footer1.jpg" class="img-fluid desk-img" alt="gp-icon-01">
                    </a>
                    <a href="index.html" class="image">
                      <img src="../src/main/webapp/img/footer/home-footer2.jpg" class="img-fluid desk-img" alt="as-icon-02">
                    </a>
                  </div>
                </div>
              </div>
          ...
          <ul class="ft-copryright-ul">
            <li class="ft-copryright-li ft-payment">
              <ul class="payment-icon">
                <li>
                  <a href="index.html">
                    <img src="../src/main/webapp/img/payment/pay-1.jpg" class="img-fluid" alt="pay-1">
                  </a>
                </li>
                <li>
                  <a href="index.html">
                    <img src="../src/main/webapp/img/payment/pay-2.jpg" class="img-fluid" alt="pay-2">
                  </a>
                </li>
                <li>
                  <a href="index.html">
                    <img src="../src/main/webapp/img/payment/pay-3.jpg" class="img-fluid" alt="pay-3">
                  </a>
                </li>
                <li>
                  <a href="index.html">
                    <img src="../src/main/webapp/img/payment/pay-4.jpg" class="img-fluid" alt="pay-4">
                  </a>
                </li>
              </ul>
            </li>
      ...
      <ul class="vega-menu">
        ...
        <li class="menu-link">
          <div class="link-title">
            <a href="collection.html" class="sp-link-title">
                                    <span class="menu-img-icon">
                                        <img src="../src/main/webapp/img/menu/cate-menu5.jpg" class="img-fluid" alt="cate-menu5">
                      ...
                      <li class="menumegasup-li">
                        <div class="product-menu-list">
                          <div class="single-product-wrap">
                            <div class="product-image">
                              <a href="product-template.html" class="pro-img">
                                <img class="img-fluid img1" src="../src/main/webapp/img/menu/home-pro-banner3.jpg" alt="menupro-3">
                                <img class="img-fluid img2" src="../src/main/webapp/img/menu/home-pro-banner4.jpg" alt="menupro-4">
                              </a>
                            </div>
                            <div class="product-content">
                      ...
                      <li class="menumegasup-li">
                        <div class="product-menu-list">
                          <div class="single-product-wrap">
                            <div class="product-image">
                              <a href="product-template.html" class="pro-img">
                                <img class="img-fluid img1" src="../src/main/webapp/img/menu/home-pro-banner7.jpg" alt="menupro-3">
                                <img class="img-fluid img2" src="../src/main/webapp/img/menu/home-pro-banner8.jpg" alt="menupro-4">
                              </a>
                            </div>
                            <div class="product-content">
                              <h6><a href="product-template.html">Shoot drone</a></h6>
