            ...
            <div class="col">
                <ul class="notification-content">
                    <li class="noti-wrap noti-call-wrap">
                        <div class="noti-call">
                            <div class="calltext">
                                <p>Need help? call us : <a href="#">(+92) 0123 456 789</a></p>
                            </div>
                        </div>
                    </li>
                    <li class="noti-wrap noti-text-wrap">
                        <div class="noti-text">
                            <p>With warranty &amp; free shipping for above $78.00</p>
                        </div>
                    </li>
                                ...
                                <li class="side-wrap user-wrap">
                                    <div class="user-wrapper">
                                        <a class="javascript:void(0) collapsed" data-bs-toggle="collapse" href="#store-account" aria-expanded="false">
                                            ...
                                            <span class="user-title">Sign in</span>
                                        </a>
                    ...
                    <div class="header-area">
                        <div class="header-element header-logo">
                            <div class="header-theme-logo">
                                <a href="index2.html" class="theme-logo">
                                    <img src="img/logo/logo9.png" class="img-fluid" alt="logo">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="mainmenu-content collapse show" id="main-collapse">
                                <div class="main-wrap">
                                    <ul class="main-menu">
                                            ...
                                            <div class="menu-dropdown menu-banner collapse" id="collapse-shop">
                                                <ul class="ul">
                                                    <li class="menubanner-li">
                                                        <div class="menubanner-img">
                                                            <a href="collection.html" class="banner-hover">
                                                                <img src="img/menu/home9-banner1.jpg"  class="img-fluid" alt="menu-banner1">
                                                            </a>
                                                            <a href="javascript:void(0)" class="collection-title">
                                                    ...
                                                    <li class="menubanner-li">
                                                        <div class="menubanner-img">
                                                            <a href="collection.html" class="banner-hover">
                                                                <img src="img/menu/home9-banner2.jpg" class="img-fluid" alt="menu-banner2">
                                                            </a>
                                                            <a href="javascript:void(0)" class="collection-title">
                                                    ...
                                                    <li class="menubanner-li">
                                                        <div class="menubanner-img">
                                                            <a href="collection.html" class="banner-hover">
                                                                <img src="img/menu/home9-banner3.jpg" class="img-fluid" alt="menu-banner3">
                                                            </a>
                                                            <a href="javascript:void(0)" class="collection-title">
                                                    ...
                                                    <li class="menubanner-li">
                                                        <div class="menubanner-img">
                                                            <a href="collection.html" class="banner-hover">
                                                                <img src="img/menu/home9-banner4.jpg" class="img-fluid" alt="menu-banner4">
                                                            </a>
                                                            <a href="javascript:void(0)" class="collection-title">
                                        ...
                                        <li class="menu-link">
                                            <a href="colection.html" class="link-title">
                                                ...
                                                <ul class="ul container p-0">
                                                    <li class="menumega-li">
                                                        <a href="javascript:void(0)" class="menumega-title">
                                                            <span class="sp-link-title">Headphones</span>
                                                            <span class="menu-arrow"><i class="fa-solid fa-angle-down"></i></span>
                                                        </a>
                                                    ...
                                                    <li class="menumega-li shop-banner-li">
                                                        <div class="shop-banner banner-hover">
                                                            <a href="collection.html">
                                                                <img src="img/menu/home9-collection-banner.jpg" class="img-fluid" alt="collectione-banner">
                                                            </a>
                                                        </div>
                                                    </li>
                                                </ul>
                        ...
                        <div class="header-element header-icon">
                            <ul class="shop-element">
                                ...
                                <li class="side-wrap icon-text-wrap">
                                    <div class="icon-text">
                                                <span class="icon-img">
                                                    <img src="img/menu/icon-img.png" class="img-fluid" alt="icon-img">
                                                </span>
                                        <p><a href="#" title="tel:(+92) 0123 456 789">(+92) 0123 456 789</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="header-bottam-block">
                        <div class="cat-menu-area header-bottom">
                                ...
                                <nav class="main-navigation navbar-expand-xl">
                                    ...
                                    <div class="navbar-collapse" id="navbarContent">
                                        ...
                                        <div class="categor-menu">
                                            <a href="#categor-collapse" class="cate-info collapsed" data-bs-toggle="collapse" aria-expanded="false">
                                            ...
                                            <div class="catwrap collapse" id="categor-collapse">
                                                <ul class="main-menu">
                                                    <li class="menu-link">
                                                        <a href="javascript:void(0)" class="link-title">
                                                            <img src="img/cat/cat-icon12.png" class="img-fluid" alt="Laptop">
                                                    ...
                                                    <li class="menu-link">
                                                        <a href="javascript:void(0)" class="link-title">
                                                            <img src="img/cat/cat-icon13.png" class="img-fluid" alt="Desktop">
                                                            <span class="sp-link-title">Desktop</span>
                                                        </a>
                                                        <a href="javascript:void(0)" class="link-title link-title-lg">
                                                            <img src="img/cat/cat-icon13.png" class="img-fluid" alt="Desktop">
                                                    ...
                                                    <li class="menu-link">
                                                        <a href="javascript:void(0)" class="link-title">
                                                            <img src="img/cat/cat-icon14.png" class="img-fluid" alt="Headphones">
                                                            <span class="sp-link-title">Headphones</span>
                                                        </a>
                                                        <a href="#collapse-camera" data-bs-toggle="collapse" class="link-title link-title-lg">
                                                            <img src="img/cat/cat-icon14.png" class="img-fluid" alt="Headphones">
                                                            <span class="sp-link-title">Headphones</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-link">
                                                        <a href="javascript:void(0)" class="link-title">
                                                            <img src="img/cat/cat-icon15.png" class="img-fluid" alt="Earbuds">
                                                            <span class="sp-link-title">Earbuds</span>
                                                        </a>
                                                        <a href="#collapse-headphone" data-bs-toggle="collapse" class="link-title link-title-lg">
                                                            <img src="img/cat/cat-icon15.png" class="img-fluid" alt="Earbuds">
                                                            <span class="sp-link-title">Earbuds</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-link">
                                                        <a href="javascript:void(0)" class="link-title">
                                                            <img src="img/cat/cat-icon16.png" class="img-fluid" alt="Speakers">
                                                    ...
                                                    <li class="menu-link">
                                                        <a href="javascript:void(0)" class="link-title">
                                                            <img src="img/cat/cat-icon17.png" class="img-fluid" alt="Fan">
                                                            <span class="sp-link-title">Fan</span>
                                                        </a>
                                                        <a href="javascript:void(0)" class="link-title link-title-lg">
                                                            <img src="img/cat/cat-icon17.png" class="img-fluid" alt="Fan">
                                                            <span class="sp-link-title">Fan</span>
                                                    ...
                                                    <li class="menu-link">
                                                        <a href="javascript:void(0)" class="link-title">
                                                            <img src="img/cat/cat-icon18.png" class="img-fluid" alt="Smart watch">
                                        ...
                                        <div class="mobile-menu-area">
                                            <a href="#mobile-menu" class="mobile-toggle collapsed" data-bs-toggle="collapse" aria-expanded="false">
                                                <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
                                                <span>Menu</span></a>
                                            <div class="mobile-menu collapse show" id="mobile-menu">
                                                <div class="mobile-contents">
                                                    <div class="mobilemenu-content">
                                                        <div class="main-wrap">
                                                            <ul class="main-menu">
                                                                <li class="menu-link">
                                                                    <a href="#menu-single" class="link-title collapsed" data-bs-toggle="collapse" aria-expanded="true">
                                                                        <span class="sp-link-title">Home</span>
                                                                    ...
                                                                    <div class="menu-dropdown menu-banner collapse" id="menu-shop-banner">
                                                                        <ul class="ul container p-0">
                                                                            ...
                                                                            <li class="menubanner-li">
                                                                                <div class="menubanner-img banner-hover">
                                                                                    <a href="collection.html" class="collection-img banner-img">
                                                                                        <img src="img/menu/home9-banner4.jpg" class="img-fluid" alt="menu-banner3">
                                                                                    </a>
                                                                                    <a href="collection.html" class="collection-title">
                                                                                        <span>Top product</span>
                                                                                    </a>
                                                                ...
                                                                <li class="menu-link">
                                                                    ...
                                                                    <div class="menu-dropdown menu-mega collapse" id="menu-mega" style="">
                                                                        <ul class="ul container p-0">
                                                                            <li class="menumega-li">
                                                                                <a href="#menumega-sup1" class="menumega-title collapsed" data-bs-toggle="collapse" aria-expanded="false">
                                                                                    <span class="sp-link-title">Headphones</span>
                                                                                    <span class="menu-arrow"><i class="fa-solid fa-angle-down"></i></span>
                                                                                </a>
                                                                                    ...
                                                                                    <ul class="menumegasup-ul">
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="product-template.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">Air buds</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="product-template.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">Hard drive</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="product-template.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">Mixer grinder</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="product-template.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">Party speakers</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="product-template.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">Smart phone</span>
                                                                                            </a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                            ...
                                                                            <li class="menumega-li">
                                                                                ...
                                                                                <div class="menumegasup-dropdown collapse show" id="menumega-sup2">
                                                                                    <ul class="menumegasup-ul">
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="collection.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">DSLR camera</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="collection.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">Large tablet</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="collection.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">Horizon book</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="collection.html" class="menumegasup-title">
                                                                                                <span class="sp-link-title">Play game</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="collection.html" class="menumegasup-title">
                                                                            ...
                                                                            <li class="menumega-li">
                                                                                ...
                                                                                <div class="menumegasup-dropdown collapse show" id="menumega-sup3">
                                                                                    <ul class="menumegasup-ul">
                                                                                        <li class="menumegasup-li">
                                                                                            <a href="product-template.html" class="menumegasup-title">
                                                                            ...
                                                                            <li class="menumega-li shop-banner-li">
                                                                                <div class="shop-banner banner-hover">
                                                                                    <a href="javascript:void(0)" class="banner-img">
                                                                                        <img src="img/menu/home9-collection-banner.jpg" class="img-fluid" alt="shop-banner">
                                                                                    </a>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                        ...
                                                                        <ul class="ul">
                                                                            <li class="menusub-li">
                                                                                ...
                                                                                <div class="menusup-dropdown collapse" id="about-us">
                                                                                    <ul class="menusup-ul">
                                                                                        <li class="menusup-li">
                                                                                            <a href="javascript:void(0)" class="menusup-title">
                                                                                                <span class="sp-link-title">About us</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menusup-li">
                                                                                            <a href="javascript:void(0)" class="menusup-title">
                                                                                                <span class="sp-link-title">About us2</span>
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="menusup-li">
                                                                                            <a href="javascript:void(0)" class="menusup-title">
                                                                                                <span class="sp-link-title">About us3</span>
                                                                                            </a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                            ...
                                                                            <li class="menusub-li">
                                                                                <a href="shipping-policy.html" class="menusub-title">
                            ...
                            <div class="home-service-icon">
                                <div class="service-wrapper">
                                    <div class="service-wrap">
                                        <div class="service-slider owl-carousel owl-theme" id="home-service">
                                            <div class="item">
                                    ...
                                    <div class="search-box">
                                        <form action="search.html" method="get" class="search-bar">
                                            <div class="form-search">
                                                <input type="search" name="q" placeholder="Search product here..." class="search-input">
                        ...
                        <div class="bottom-block cart-area">
                            <div class="cart-wrapper">
                                <a class="add-to-cart" href="javascript:void(0)">
                                    <span class="icon"><i class="fa-solid fa-cart-shopping"></i></span>
                                    <span id="cart-total" class="bigcounter">4</span>
                                    <span class="cart-title text">Item - </span>
                                    <span class="subtotal-price text">$0.00</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col">
                <div class="footer-list">
                    <ul class="footer-ul">
                        <li class="footer-li footer-contact" data-animate="animate__fadeInUp">
                            <ul class="ftlist-ul">
                                <li class="ftlist-li">
                                    ...
                                    <a href="#footer-store-information" class="ftlist-title" data-bs-toggle="collapse" aria-expanded="false">
                                        <span>Contact us</span>
                                        <span><i class="fa-solid fa-plus"></i></span>
                                    </a>
                                    <ul class="ftcontact-ul collapse" id="footer-store-information">
                                        ...
                                        <li class="ftcontact-li">
                                            <div class="ft-contact-add">
                                                ...
                                                <a href="tel:0123456789" class="ft-contact-address">610-403-403</a>
                                            </div>
                                        </li>
                                        <li class="ftcontact-li">
                                            <div class="ft-contact-add">
                                                <span class="ft-contact-icon"><i class="fa-solid fa-at"></i></span>
                        ...
                        <li class="footer-li footer-menu" data-animate="animate__fadeInUp">
                            <ul class="ftlist-ul">
                                <li class="ftlist-li">
                                    ...
                                    <ul class="ftlink-ul collapse" id="footer-my-account">
                                        ...
                                        <li class="ftlink-li">
                                            <a href="create-account.html">Delivery information</a>
                                        </li>
                                        <li class="ftlink-li">
                                        ...
                                        <li class="ftlink-li">
                                            <a href="collection.html">Brands</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <ul class="ftlist-ul">
                                <li class="ftlist-li">
                                    ...
                                    <ul class="ftlink-ul collapse" id="footer-extras">
                                        <li class="ftlink-li">
                                            <a href="login-account.html">Login & register</a>
                                        </li>
                                        <li class="ftlink-li">
                                        ...
                                        <li class="ftlink-li">
                                            <a href="index2.html">Newsletter</a>
                                        </li>
                                        <li class="ftlink-li">
                                            <a href="collection.html">Specials</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="footer-li footer-menu" data-animate="animate__fadeInUp">
                            <ul class="ftlist-ul">
                                <li class="ftlist-li">
                                    ...
                                    <a href="#footer-products" class="ftlist-title" data-bs-toggle="collapse" aria-expanded="false">
                                        <span>Customer care</span>
                                        <span><i class="fa-solid fa-plus"></i></span>
                                    </a>
                                    <ul class="ftlink-ul collapse" id="footer-products">
                                        <li class="ftlink-li">
                                        ...
                                        <li class="ftlink-li">
                                            <a href="shipping-policy.html">Gift certificates</a>
                                        </li>
                                        <li class="ftlink-li">
                                            <a href="collection.html">Affiliate</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="footer-li footer-menu" data-animate="animate__fadeInUp">
                            <ul class="ftlist-ul">
                                <li class="ftlist-li">
                                    <h6 class="ftlist-title">Electon legal</h6>
                                    <a href="#footer-legal" class="ftlist-title" data-bs-toggle="collapse" aria-expanded="false">
                                        <span>Electon legal</span>
                                        <span><i class="fa-solid fa-plus"></i></span>
                                    </a>
                                    <ul class="ftlink-ul collapse" id="footer-legal">
                                        <li class="ftlink-li">
                                            <a href="return-policy.html">Return policy</a>
                                        </li>
                                        <li class="ftlink-li">
                                        ...
                                        <li class="ftlink-li">
                                            <a href="collection.html">Adversting</a>
                                        </li>
                                        <li class="ftlink-li">
                                            <a href="create-account.html">Contact store</a>
                                        </li>
                                        <li class="ftlink-li">
                                            <a href="search.html">Help & support</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <ul class="ft-copryright-ul">
                        <li class="ft-copryright-li ft-copyright-text">
                            <p>
                                ...
                                <span>2024 ecommerce by electon</span>
                            </p>
                        </li>
                        <li class="ft-copryright-li ft-logo-image">
                            <a href="index2.html" class="theme-logo">
                                <img src="img/logo/footer-logo9.png" class="img-fluid" alt="footer-logo">
                            </a>
                        </li>
                        <li class="ft-copryright-li ft-payment">
                            <ul class="payment-icon">
                                <li>
                                    <a href="index2.html">
                                        <img src="img/payment/home5-pay1.png" class="img-fluid" alt="pay6">
                                    </a>
                                </li>
                                <li>
                                    <a href="index2.html">
                                        <img src="img/payment/home5-pay2.png" class="img-fluid" alt="pay5">
                                    </a>
                                </li>
                                <li>
                                    <a href="index2.html">
                                        <img src="img/payment/home5-pay3.png" class="img-fluid" alt="pay4">
                                    </a>
                                </li>
                                <li>
                                    <a href="index2.html">
                                        <img src="img/payment/home5-pay4.png" class="img-fluid" alt="pay2">
                                    </a>
                                </li>
                            </ul>
                        </li>
