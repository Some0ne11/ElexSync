                                ...
                                <div class="product-img-top">
                                    ...
                                    <div class="slider-big-7 slick-slider">
                                        <div class="slick-slide ">
                                            <a href="img/product/harddrive.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/harddrive.jpg');">
                                                    <img src="img/product/harddrive.jpg" class="img-fluid" alt="pro-1">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/harddrive2.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/harddrive2.jpg');">
                                                    <img src="img/product/harddrive2.jpg" class="img-fluid" alt="pro-2">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/harddrive3.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/harddrive3.jpg');">
                                                    <img src="img/product/harddrive3.jpg" class="img-fluid" alt="p-3">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/harddrive4.jpg" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/harddrive4.jpg');">
                                                    <img src="img/product/harddrive4.jpg" class="img-fluid" alt="pro-4">
                                                </figure>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slider-small-7 pro-detail-slider small-slider">
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                                <img src="img/product/harddrive.jpg" class="img-fluid" alt="macbook1">
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                                <img src="img/product/harddrive2.jpg" class="img-fluid" alt="macbook2">
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                                <img src="img/product/harddrive3.jpg" class="img-fluid" alt="pro-3">
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                ...
                                <div class="pro-nprist">
                                                    ...
                                                    <div class="swatch-variant">
                                                        <div class="swatch clearfix Color">
                                                            <div class="header">
                                                                <h6>
                                                                    <span>Color:</span>
                                                                    <span class="data-value">Matcha Green</span>
                                                                </h6>
                                                            </div>
                                                            <div class="variant-wrap">
                                                                <div class="variant-property">
                                                                    <div class="swatch-element color Green">
                                                                        <input type="radio" name="option-0" value="Matcha Green" id="color-green" checked>
                                                                        <label for="color-green">Matcha Green</label>
                                                                    </div>
                                                                    ...
                                                                    <div class="swatch-element color Blue">
                                                                        <input type="radio" name="option-0" value="Sky Blue" id="color-blue">
                                                                        <label for="color-blue">Sky Blue</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="product-form-list">
                                                        <div class="single-product-wrap">
                                                            <div class="product-image">
                                                                <a class="pro-img" href="harddrive.jsp">
                                                                    <img class="img-fluid img1 resp-img1" src="img/product/harddrive.jpg"
                                                                         alt="p-1">
                                                                    <img class="img-fluid img2 resp-img2" src="img/product/harddrive2.jpg"
                                                                         alt="p-2">
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <div class="pro-title-price">
                                                                    <h6><a href="harddrive">Hard Drive</a></h6>
                                    ...
                                    <div class="product-info">
                                        <div class="product-sku">
                                            <h6>SKU:</h6>
                                            <span class="variant-sku">HDD-1234-SG</span>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                ...
                                <div class="collapse show" id="description" data-bs-parent="#collapse-tab" role="tab" aria-expanded="true">
                                    <div class="description-review-text">
                                        <div class="product-description">
                                            <p>The External Hard Disk is a reliable and high-capacity storage solution for your data. Designed to provide secure, portable, and fast access to your files, it's perfect for both personal and professional use.</p>
                                            <h6>About this item</h6>
                                            <ul>
                                                <li>Available in multiple storage capacities: 1TB, 2TB, 4TB, and more.</li>
                                                <li>USB 3.0 and USB-C compatibility for fast data transfer speeds.</li>
                                                <li>Compact and lightweight design for easy portability.</li>
                                                <li>Durable build with shock resistance to protect your data.</li>
                                                <li>Compatible with Windows, macOS, and Linux operating systems.</li>
                                                <li>Includes backup software for easy and secure data management.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="description-review-text">
                                        <div class="product-additional-info">
                                            <table>
                                                ...
                                                <tr class="product-info">
                                                    <th>Model</th>
                                                    <td>Backup Plus Slim</td>
                                                </tr>
                                                <tr class="product-info">
                                                    <th>Color</th>
                                                    <td>Green, Gray, Blue</td>
                                                </tr>
                                                <tr class="product-info">
                                                    <th>SKU</th>
                                                    <td>HDD-1234-SG</td>
                                ...
                                <div class="collapse" id="other-content" data-bs-parent="#collapse-tab">
                                    <div class="description-review-text">
                                        <div class="product-custom-content">
                                            <p>This External Hard Disk is an essential tool for anyone needing extra storage for backups, multimedia, and professional projects. Its robust design and versatile compatibility make it a trusted companion for all your data needs.</p>
                                            <p>Perfect for professionals, students, and anyone requiring reliable data storage on the go.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                    ...
                                    <div class="description-review-text">
                                        <div class="video">
                                            <div class="video-wrapper">
                                                <iframe src="https://www.youtube.com/embed/U_xpdNhSuRQ?si=D2R-Fy7RRP7iPKB3" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
