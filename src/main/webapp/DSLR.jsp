                            ...
                            <div class="product-detail-img product-detail-img-bottom">
                                <div class="product-img-top">
                                    ...
                                    <div class="slider-big-7 slick-slider">
                                        <div class="slick-slide ">
                                            <a href="img/product/cam1.png" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/cam1.png');">
                                                    <img src="img/product/cam1.png" class="img-fluid" alt="pro-1">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/cam2.png" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/cam2.png');">
                                                    <img src="img/product/cam2.png" class="img-fluid" alt="pro-2">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/cam3.png" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/cam3.png');">
                                                    <img src="img/product/cam3.png" class="img-fluid" alt="p-3">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="img/product/cam4.png" class="product-single">
                                                <figure class="zoom" onmousemove="zoom(event)" style="background-image: url('img/product/cam4.png');">
                                                    <img src="img/product/cam4.png" class="img-fluid" alt="pro-4">
                                                </figure>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="pro-slider">
                                    <div class="slider-small-7 pro-detail-slider small-slider">
                                        ...
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                                <img src="img/product/cam3.png" class="img-fluid" alt="pro-3">
                                            </a>
                                        </div>
                                        <div class="slick-slide ">
                                            <a href="javascript:void(0)" class="product-single--thumbnail">
                                ...
                                <div class="pro-nprist">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-ratting">
                                            ...
                                            <span class="spr-badge-caption">21 Reviews</span>
                                        </div>
                                        <!-- product-rating end -->
                                    </div>
                                    <div class="product-info">
                                        <div class="pro-prlb pro-sale">
                                            <div class="price-box">
                                                <span class="new-price">RM 1300.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                        <div class="product-inventory">
                                            <div class="stock-inventory stock-more">
                                                <p class="text-success">Hurry up! only
                                                    <span class="available-stock bg-success">30</span>
                                                    ...
                                                    <div class="product-form-list">
                                                        <div class="single-product-wrap">
                                                            <div class="product-image">
                                                                <a class="pro-img" href="collection.jsp">
                                                                    <img class="img-fluid img1 resp-img1" src="img/product/cam2.png"
                                                                         alt="p-1">
                                                                    <img class="img-fluid img2 resp-img2" src="img/product/cam4.png"
                                                                         alt="p-2">
                                                                </a>
                                                            </div>
                                                            <div class="product-content">
                                                                <div class="pro-title-price">
                                                                    <h6><a href="DSLR.jsp">Hard Drives</a></h6>
                                ...
                                <div class="collapse show" id="description" data-bs-parent="#collapse-tab" role ="tab" aria-expanded="true">
                                    <div class="description-review-text">
                                        <div class="product-description">
                                            <p>Capture Stunning Moments and Expand Your Photography with this High-Performance DSLR Camera.
                                                With advanced features, fast autofocus, and a durable design, it’s perfect for both amateur
                                                and professional photographers. Whether you’re shooting high-resolution images or recording
                                                stunning videos, this camera delivers reliability and performance you can count on.</p>
                                            <h6>About this item</h6>
                                            <ul>
                                                <li>High Image Quality: Capture breathtaking photos and videos with impressive clarity and detail.</li>
                                                <li>Fast Autofocus: Quickly lock onto your subject with advanced autofocus technology.</li>
                                                <li>Durable Design: Built to withstand various shooting conditions, keeping your gear safe.</li>
                                                <li>Portable: Lightweight and compact for easy transport, ideal for on-the-go photography.</li>
                                                <li>User-Friendly Interface: Ready to use without any complicated setup, perfect for beginners.</li>
                                                <li>Wide Compatibility: Works with various lenses and accessories, suitable for different photography styles.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="product-additional-info">
                                            <table>
                                                ...
                                                <tr class="product-info">
                                                    <th>Type</th>
                                                    <td>
                                                        <a href="javascript:void(0)">Memory Card</a>
                                                    </td>
                                                </tr>
                                                <tr class="product-info">
                                                    <th>Color</th>
                                    ...
                                    <div class="description-review-text">
                                        <div class="video">
                                            <div class="video-wrapper">
                                                <iframe src="https://www.youtube.com/embed/Pc41LSvbkjc?si=OUn6HmX_o6xeoVoA" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
